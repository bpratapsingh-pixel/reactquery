...
export default function LoginSignUpPageView({ isModal }) {
    const {
        isSignUp,
        control,
        handleSubmit,
        ...
        onSubmit,
        toggleMode,
    } = useLoginHook({ isModal });

    if (isModal) {
        return (
            <div className="bg-[#0C0630] p-4 sm:p-8 rounded-3xl border border-white/10 shadow-2xl max-w-lg w-full relative mx-auto">
                ...
                <div className="flex w-full lg:w-1/2 flex-col items-center justify-center px-4 py-12 sm:px-8 md:px-12 lg:px-16 overflow-y-auto">
                    <div className="w-full max-w-[24rem] sm:max-w-[28rem] space-y-6 sm:space-y-8">
                        ...
                        <p className="text-center text-xs sm:text-sm text-white/40">
                            ...
                            <span className="underline cursor-pointer hover:text-white mx-1">
                                Terms
                            </span>
                            &
                            <span className="underline cursor-pointer hover:text-white mx-1">
